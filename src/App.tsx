          ...
          <div className="container py-4">
            <FadeInSection>
              ...
              <div className="list-group max-w-75 mx-auto" style={{ maxWidth: '800px' }}>
                <a href="https://github.com/AlexKovalovSHK/ifob_scool" target="_blank" className="list-group-item list-group-item-action p-4 border-light shadow-sm mb-3 rounded">
